...
var Student = function (knowInput) {
	
	this.expertise = knowInput
	this.knowledge = 0
	this.learn = function (amtKnow) {
		this.knowledge += amtKnow
	}
...
var Safe = function (data, instance) {
	var secret = data //>>>secret becomes "shhh!"
	var password = instance //>>>password becomes new Key
